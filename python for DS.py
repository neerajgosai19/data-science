...
import pandas as pd
Gdpdata = links["GDP"]
gdpDataFrame = pd.read_csv(Gdpdata)    
x =   pd.DataFrame(gdpDataFrame , columns = ['date'])  # Create your dataframe with column date
x.head()
...
import pandas as pd
gdpda1 = links["GDP"]
gdp_change_df = pd.read_csv(gdpda1)
gdp_change = pd.DataFrame(gdp_change_df , columns =  ['change-current'])  # Create your dataframe with column change-current
gdp_change.head()
...
import pandas as pd
unemployment_data1 = links["unemployment"]
unemployment_df = pd.read_csv(unemployment_data1)
unemployment = pd.DataFrame(unemployment_df , columns =['unemployment'] )   # Create your dataframe with column unemployment
unemployment.head()                  
...
title = "unemplyment corrusponds to gdp "# Give your dashboard a string title
...
credentials =  {
  "apikey": "WN3PDRkxXAlK2CU_7G-jzW6x2YILz7dJWLMZikBBITd1",
  "cos_hmac_keys": {
    "access_key_id": "00e2b97200d549c3a1a612eb1d2c53a6",
    "secret_access_key": "5c6a650bfeb030219640d56cfcaa82e3765dccdbf0a3764e"
  },
  "endpoints": "https://control.cloud-object-storage.cloud.ibm.com/v2/endpoints",
  "iam_apikey_description": "Auto-generated for key 00e2b972-00d5-49c3-a1a6-12eb1d2c53a6",
  "iam_apikey_name": "WDP-Project-Management-8f654bb0-5b7d-4d18-b286-67ec08579edc",
  "iam_role_crn": "crn:v1:bluemix:public:iam::::serviceRole:Manager",
  "iam_serviceid_crn": "crn:v1:bluemix:public:iam-identity::a/a5b647d5da4c4e51aa20262b37d03b50::serviceid:ServiceId-e8df2615-edf6-4e30-93ef-de03a450ce3f",
  "resource_instance_id": "crn:v1:bluemix:public:cloud-object-storage:global:a/a5b647d5da4c4e51aa20262b37d03b50:8f654bb0-5b7d-4d18-b286-67ec08579edc::"
}
...
bucket_name = "pythonfordatascience-donotdelete-pr-cp7wsxeq1f0u63"     # Type your bucket name on IBM Cloud
